...
const MyProfile = () => {
    ...
    return userData && (
        <div className='max-w-lg flex flex-col gap-2 text-sm'>
            ...
            {isEdit
                ? <input
                    className='bg-gray-50 text-3xl font-medium max-w-60 mt-4 border rounded px-2'
                    type="text"
                    value={userData.name}
            ...
            <div>
                ...
                <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
                    ...
                    {isEdit
                        ? <input
                            className='bg-gray-50 max-w-52 border rounded px-2'
                            type="text"
                            value={userData.phone || ''}
                            onChange={(e) => setUserData(prev => ({ ...prev, phone: e.target.value }))}
                          />
                        : <p className='text-blue-400'>{userData.phone || 'Not Specified'}</p>
                    }
                    ...
                    {isEdit
                        ? <p>
                            <input
                                className='bg-gray-50 border rounded px-2'
                                type="text"
            ...
            <div>
                ...
                <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
                    ...
                    {isEdit
                        ? <select
                            className='max-w-20 bg-gray-50 border rounded px-2'
                    ...
                    {isEdit
                        ? <input
                            className='max-w-28 bg-gray-50 border rounded px-2'
                            type="date"
                            value={userData.dob && userData.dob !== 'Not Specified' ? userData.dob : ''}
